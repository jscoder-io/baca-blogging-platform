    ...
    <div>
        ...
        <form class="flex flex-col sm:flex-row">
            ...
            <div class="mt-2 flex w-full rounded-md shadow-sm sm:mt-0 sm:ml-3">
                <button class="w-full rounded-md bg-teal-500 py-2 px-4 font-medium text-white sm:py-0 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-600 focus:ring-offset-2" type="submit">Sign up</button>
            </div>
        </form>
    </div>
</div>
